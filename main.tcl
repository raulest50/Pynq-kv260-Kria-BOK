...
#
# main.tcl: Tcl script for re-creating project 'bp_01'
#
# Generated by Vivado on Fri Mar 28 17:54:02 -0500 2025
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set paths [list \
 "[file normalize "$origin_dir/[file normalize "$origin_dir/../app1_adder_ovr/adder_hls"]"]"\
  ]
  foreach ipath $paths {
...
set_property -name "platform.description" -value "Minimal kv260 xtensible platform for overlay kernel acceleration" -objects $obj
...
set_property -name "platform.name" -value "KV260_base1" -objects $obj
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../app1_adder_ovr/adder_hls"]" $obj
...
set_property -name "top" -value "sistema_wrapper" -objects $obj
...
# Proc to create BD sistema
proc cr_bd_sistema { parentCell } {
...
\
  ...
  set_property PFM_NAME {xilinx:kv260_som_som240_1_connector_kv260_carrier_som240_1_connector:KV260_base1:1.0} [get_files [current_bd_design].bd]
...
# End of cr_bd_sistema()

cr_bd_sistema ""
set_property GENERATE_SYNTH_CHECKPOINT "0" [get_files sistema.bd ] 
set_property PFM_NAME "xilinx:kv260_som_som240_1_connector_kv260_carrier_som240_1_connector:KV260_base1:1.0" [get_files sistema.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files sistema.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list sistema.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/bp_01.gen/sources_1/bd/sistema/hdl/sistema_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list sistema.bd]] -top]
